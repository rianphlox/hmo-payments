                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <a target="_blank" href="javascript:void(0)/product/paper-dashboard-2-pro?ref=pd-free-upgrade-live" class="btn btn-round btn-primary">Upgrade to PRO</a>
                        </td>
                      </tr>
                    </tbody>
                  </table>
        ...
        <div class="container-fluid">
          <div class="row">
            <nav class="footer-nav">
              <ul>
                <li><a href="javascript:void(0)" target="_blank">Creative Tim</a></li>
                <li><a href="javascript:void(0)/blog" target="_blank">Blog</a></li>
                <li><a href="javascript:void(0)/license" target="_blank">Licenses</a></li>
              </ul>
            </nav>
